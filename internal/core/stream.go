...
const (
	...
	// ControlStreamPong ...
	ControlStreamPong = 4
	// DataStreamInternalRequest ...
	DataStreamInternalRequest = 5
	// DataStreamExternalRequest ...
	DataStreamExternalRequest = 6
	// DataStreamResponseOK ...
	DataStreamResponseOK = 7
	// DataStreamResponseError ...
	DataStreamResponseError = 8
	// DataStreamBoardCast ...
	DataStreamBoardCast = 9
	// SystemStreamReportError ...
	SystemStreamReportError = 10
)
