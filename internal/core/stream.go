...
const (
	...
	// StreamKindPong ...
	StreamKindPong = 4
	// StreamKindRPCInternalRequest ...
	StreamKindRPCInternalRequest = 5
	// StreamKindRPCExternalRequest ...
	StreamKindRPCExternalRequest = 6
	// StreamKindRPCResponseOK ...
	StreamKindRPCResponseOK = 7
	// StreamKindRPCResponseError ...
	StreamKindRPCResponseError = 8
	// StreamKindRPCBoardCast ...
	StreamKindRPCBoardCast = 9
	// StreamKindSystemErrorReport ...
	StreamKindSystemErrorReport = 10
)
